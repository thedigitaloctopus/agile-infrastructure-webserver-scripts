...
/bin/echo "15 1 * * * export HOME="${HOMEDIR}" && ${HOME}/providerscripts/datastore/BackupEFSToDatastoreFromCron.sh" >> /var/spool/cron/crontabs/root
/bin/echo "15 1 * * * export HOME="${HOMEDIR}" && ${HOME}/providerscripts/datastore/BackupS3ToDatastoreFromCron.sh" >> /var/spool/cron/crontabs/root
