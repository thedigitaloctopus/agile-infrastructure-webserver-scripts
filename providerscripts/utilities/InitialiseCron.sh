...
/bin/echo "15 1 * * * export HOME="${HOMEDIR}" && ${HOME}/cron/BackupEFSToDatastoreFromCron.sh" >> /var/spool/cron/crontabs/root
/bin/echo "15 1 * * * export HOME="${HOMEDIR}" && ${HOME}/cron/BackupS3ToDatastoreFromCron.sh" >> /var/spool/cron/crontabs/root
