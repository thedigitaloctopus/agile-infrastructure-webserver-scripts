...
then
    ...
    ${HOME}/providerscripts/datastore/configwrapper/PutToConfigDatastore.sh /var/www/html/wp-config.php.default wordpress_config.php 
    /bin/touch ${HOME}/runtime/APPLICATION_CONFIGURATION_PREPARED
fi
...
if ( [ "${changed}" = "main" ] )
then
    ${HOME}/providerscripts/datastore/configwrapper/PutToConfigDatastore.sh /var/www/wp-config.php wordpress_config.php 
