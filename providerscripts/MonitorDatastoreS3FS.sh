...
# ${HOME}/runtime/MONITOR_DATASTORE_S3FS doesn't get removed, then, we know we need to act because
...
/bin/touch ${HOME}/runtime/PERFORMING_S3FS_DATASTORE_CHECK 
/bin/touch ${HOME}/runtime/MONITOR_DATASTORE_S3FS
...
do
    #If a mount has gone dodgy, this will hold us up and prevent the file below being removed which we can test for
    /bin/ls /var/www/html/${mountpoint}
done
...
/bin/rm ${HOME}/runtime/MONITOR_DATASTORE_S3FS
